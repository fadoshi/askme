...
export const DashboardCommand = ({open, setOpen}: Props) => {
    ...
    const trpc = useTRPC();
    const meetings = useQuery(trpc.meetings.getMany.queryOptions({search, pageSize: MAX_PAGE_SIZE}));
    const agents = useQuery(trpc.agents.getMany.queryOptions({search, pageSize: MAX_PAGE_SIZE}));
