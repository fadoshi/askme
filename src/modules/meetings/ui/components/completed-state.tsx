...
export const CompletedState = ({data}: Props) => {
    return (
        <div className="flex flex-col gap-y-4">
          ...
          border-transparent data-[state=active]:border-b-primary data-[state=active]:text-accent-foreground 
          ...
          h-full hover:text-accent-foreground"
                ...
                <TabsContent value="recording">
                    <div className="bg-white rounded-lg border px-4 py-5">
                        <p>**These recordings have expiration limit of 2 weeks with stream in AWS S3**</p>
                        <video
                ...
                <TabsContent value="chat">
                    ...
                    <EmptyState
                    title="Chat Bot will arrive soon!"
                    description="Chat With AI feature will be introduce soon."
                    />
                </TabsContent>
            </Tabs>
        </div>
