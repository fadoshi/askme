    ...
    return (
      <Drawer {...props}>
        <DrawerContent className="overflow-hidden p-0">
          ...
          <Command shouldFilter={shouldFilter} className="[&_cmdk-group-heading]:text-muted-foreground 
      **:data-[slot=command-input-wrapper]:h-12 
      [&_cmdk-group-heading]:px-2 
      [&_cmdk-group-heading]:font-medium 
      [&_cmdk-group]:px-2 
      [&_cmdk-group]:not([hidden])~[_cmdk-group]:pt-0 
      [&_cmdk-input-wrapper]:h-5 
      [&_cmdk-input-wrapper_svg]:w-5 
      [&_cmdk-input]:h-12 
      [&_cmdk-item]:px-2 
      [&_cmdk-item]:py-3 
      [&_cmdk-item_svg]:h-5 
